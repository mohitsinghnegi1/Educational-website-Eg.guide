...
<body>
  ...
  <section id="features" class="padd-section text-center wow fadeIn " style="">
    <p><img class="mt-0" src="img/coding.gif" style="height:150px;width:auto; margin-top:-10px; margin-bottom:-10px;"></p>
  ...
  <!--team section-->       
  <section id="team" class="padd-section text-center wow fadeIn mt-5">
    ...
    <div id="flip">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-md-4 col-lg-3 wow fadeIn">
  ...
  <!--==========================
    Contact Section
  ============================-->
  <section id="contact" class="padd-section wow fadeIn ">
